...
![Alt text](images/sentinel_1_satellite.png)
...
![Alt text](images/pwtt_pre_post.png)
...
![Alt text](images/VV change in backscatter for a random location which has had a fire.png)

]

.pull-right[
VH backscatter for the same location with fires overlaid (also using SNNs)
![Alt text](images/VH change in backscatter for a random location which has had a fire.png)
